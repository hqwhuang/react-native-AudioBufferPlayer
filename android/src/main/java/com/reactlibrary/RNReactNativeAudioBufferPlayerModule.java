...
public class RNReactNativeAudioBufferPlayerModule extends ReactContextBaseJavaModule {
  ...
  public void initialize(int hz, Promise promise){
    try{
      track = new AudioTrack(AudioManager.STREAM_MUSIC, hz, AudioFormat.CHANNEL_CONFIGURATION_MONO, AudioFormat.ENCODING_PCM_16BIT, 8192, AudioTrack.MODE_STREAM);
      track.play();
  ...
  @ReactMethod
  public void playAudioBuffer(byte[] buffer, int bufferSize, Promise promise){
    try{
